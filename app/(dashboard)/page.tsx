import { GetForm, GetFormStats } from "@/actions/from";
import {
  Card,
  CardContent,
  CardDescription,
...
export default function Home() {
  return (
    <div className="container pt-4">
      ...
      <h2 className="col-span-2 font-bold text-4xl">Your Forms</h2>
      <Separator className="my-6" />
...
function FormCardSkeleton() {
  return <Skeleton className="border-2 border-primary-/28 h-[190px] w-full" />;
}
